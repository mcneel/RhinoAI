...
If you're here to hack on <strong>Rhino MCP itself</strong>, see the <a href="https://github.com/mcneel/RhinoAI#building--debugging">contributing notes on GitHub</a>.
</blockquote>
