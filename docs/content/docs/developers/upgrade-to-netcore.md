...
If you have a Rhino plugin still targeting `net45` or `net48`, you'll want to move it to `net8.0` (Rhino 8) which will also work for (Rhino 9 WIP/BETA). This page showcases how you can use Rhino AI to make this upgrade seamless.
