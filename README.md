...
The fastest path is [Claude Desktop](https://mcneel.github.io/RhinoAI/docs/getting-started/connector/): install the [Rhino3d connector](https://github.com/mcneel/RhinoAI/releases/download/connector-v0.1.3/connector.mcpb) and let it install the Rhino plugin for you. For other assistants, see [Getting Started](https://mcneel.github.io/RhinoAI/docs/getting-started/).
