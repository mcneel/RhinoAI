...
const ICONS = {
  ...
  download: [{ line: [12, 3.5, 12, 14.5] }, { path: 'M7.5 10l4.5 4.5 4.5-4.5' }, { path: 'M4.5 17v2.5h15V17' }],
  popOut: [{ path: 'M19 13v6a1.5 1.5 0 0 1-1.5 1.5h-12A1.5 1.5 0 0 1 4 19V7a1.5 1.5 0 0 1 1.5-1.5h6' }, { path: 'M14 3.5h6.5V10' }, { line: [11.5, 12.5, 20.5, 3.5] }],
