...
namespace RhinoAI.Router.Codegen;
...
public class RouterToolGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(tools.Collect(), static (spc, all) =>
        {
            ...
            sb.AppendLine("namespace RhinoAI.Router.Tools.Generated;");
            sb.AppendLine();
    ...
    private static void EmitProxy(StringBuilder sb, ToolInfo tool)
    {
        ...
        sb.AppendLine($"public class {className}(global::RhinoAI.Router.ProxyDispatcher proxy)");
        sb.AppendLine("{");
    ...
    private static void EmitRegistrar(StringBuilder sb, ImmutableArray<ToolInfo> tools)
    {
        ...
        sb.AppendLine("    {");
        sb.AppendLine("        builder = global::Microsoft.Extensions.DependencyInjection.McpServerBuilderExtensions.WithTools<global::RhinoAI.Router.Tools.SpawnSlotTool>(builder, options);");
        foreach (var tool in tools)
        {
            sb.AppendLine($"        builder = global::Microsoft.Extensions.DependencyInjection.McpServerBuilderExtensions.WithTools<global::RhinoAI.Router.Tools.Generated.{tool.ClassName}Proxy>(builder, options);");
        }
